...
In 2017, I left a full-stack engineering job at [Navya.Care](#) to build a company. **[IntuitionAI](https://intuition.ai)** was a small team — a couple of founders, an ML scientist, and me — and the bet was a simple one that turned out to be early. *Companies are deploying machine learning models to production. They have no idea what those models are doing once they ship.*
