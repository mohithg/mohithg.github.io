...
<Owned items={[
  "<strong>At IntuitionAI:</strong> built the model monitoring service from scratch — drift detection, data-quality checks, prediction logging, alerting.",
  "Stood up the entire stack solo for the first six months: ingestion, storage, the dashboard, the alerting, the customer-facing SDK.",
  "Owned the integration into Domino's platform after acquisition — both the technical migration and the product re-shaping.",
  "<strong>At Domino:</strong> joined the core platform team. Worked on the parts of Domino that the rest of Domino is built on.",
...
<Architecture
  ...
  nodes={[
    ...
    { id: "ingest", label: "Prediction Ingest", layer: "data", x: 380, y: 80, owned: "built", note: "high-throughput · idempotent" },
    { id: "drift", label: "Drift / DQ Engine", layer: "ai", x: 380, y: 220, owned: "built", note: "windowed · streaming" },
...
I left in mid-2021 not because anything was wrong, but because the LLM revolution was about to start and I wanted to be back at company-zero. I joined Global Predictions a few weeks later as their first engineer. The rest is a separate case study.
